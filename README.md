# ServeHub Cliente — protótipo PWA

Protótipo navegável do **ServeHub Cliente**, empacotado como PWA instalável (site estático, sem build).

## O que é

Gerado a partir do protótipo do Claude Design `Prototipos/ServeHub App Cliente.html` (o arquivo original
...
```bash
node tools/build.js "/caminho/para/ServeHub App Cliente.html"
```
